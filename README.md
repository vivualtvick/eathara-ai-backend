...
### [Click to see Deployment Guide](https://github.com/vivualtvick/eathara-ai-backend/blob/main/deployment.md)
...
```bash
git clone https://github.com/vivualtvick/eathara-ai-backend.git
cd eathara-ai-backend
```
